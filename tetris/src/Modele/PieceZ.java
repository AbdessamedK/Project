...
public class PieceZ extends Piece {
    private void creerPiece() {
        int x = 4, y = 1 ;
        this.tab[0] = new CaseSimple(x,y,6,true) ;
        this.tab[1] = new CaseSimple(x+1,y,6,true) ;
        this.tab[2] = new CaseSimple(x,y-1,6,true) ;
        this.tab[3] = new CaseSimple(x-1,y-1,6,true) ;
    }
