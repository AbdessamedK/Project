...
public class ScreenPauseJ1 extends Screen{
    ...
    public ScreenPauseJ1(JeuTetris _jeu)
    {
        this.jeu = _jeu;
    ...
    public void initialize()
    {
        ...
        ImageIcon backgroundImageIcon = new ImageIcon(Objects.requireNonNull(getClass().getResource("../data/7.png")));
