...
/**
 *  Test message list manipulations with Length Strategy.
 */
public class TestSortMessagesLengthStrategy {
        @Test
        void test() {
                // Given
                ...
                Message m1 = new Message("spam, fake!", temp);
                add(msgs, m1);
                Message m2 = new Message("spam, you!", dateMinus3DaysAsDate, temp);
                add(msgs, m2);
                Message m3 = new Message("What is this message ?", dateMinus3WeeksAsDate, temp);
                add(msgs, m3);
                ...
                // Then
                assertThat(msgs.get(m1).getScore(), is(11));
                assertThat(msgs.get(m2).getScore(), is(10));
                assertThat(msgs.get(m3).getScore(), is(22));
                assertThat(msgs.get(m4).getScore(), is(28));
                assertThat(msgs.get(m5).getScore(), is(28));
                
                assertThat(sortedMessageList, contains(m1, m4, m5, m3, m2));
        }
