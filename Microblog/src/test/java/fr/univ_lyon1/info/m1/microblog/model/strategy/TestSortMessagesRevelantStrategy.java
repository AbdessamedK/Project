...
/**
 *  Test message list manipulations with Revelant Strategy.
 */
public class TestSortMessagesRevelantStrategy {
         @Test
    ...
    void test() {
        ...
        assertThat(msgs.get(m4).getScore(), is(0));
        assertThat(msgs.get(m5).getScore(), is(0));

        
        
        assertThat(sortedMessageList, contains(m1, m2));
    }
