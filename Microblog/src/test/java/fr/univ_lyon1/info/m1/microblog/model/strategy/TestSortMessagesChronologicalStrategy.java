...
/**
 *  Test message list manipulations with Chronological Strategy.
 */
public class TestSortMessagesChronologicalStrategy {
        @Test
        void test() {
                // Given
                ...
                assertThat(msgs.get(m5).getScore(), is(1));
                
                assertThat(sortedMessageList, contains(m1, m4, m3, m5, m2));
        }
