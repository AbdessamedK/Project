...
/**
 *  Test message list manipulations with Revelant and Recent Strategy.
 */
public class TestSortMessagesRevelantRecentStrategy {
    @Test
    void dummyTestMessageContent() {
        // Given
        
        Message m = new Message("Some content", new User("temp", Role.USER));
    ...
    void test() {
        ...
        Message m1 = new Message("Hello, world!", temp);
        add(msgs, m1);
        Message m2 = new Message("Hello, you!", temp);
        add(msgs, m2);
        Message m3 = new Message("What is this message ?", temp);
        add(msgs, m3);
        Message m4 = new Message("This is message with score 1", dateMinus2DaysAsDate, temp);
        add(msgs, m4);
        Message m5 = new Message("This is message with score 0", dateMinus2WeeksAsDate, temp);
        add(msgs, m5); 
        ...
        // Then
        assertThat(msgs.get(m1).getScore(), is(4));
        assertThat(msgs.get(m2).getScore(), is(3));
        assertThat(msgs.get(m3).getScore(), is(2));
        assertThat(msgs.get(m4).getScore(), is(1));
        assertThat(msgs.get(m5).getScore(), is(0));

        
        
        assertThat(sortedMessageList, contains(m1, m2, m3, m4));
    }
