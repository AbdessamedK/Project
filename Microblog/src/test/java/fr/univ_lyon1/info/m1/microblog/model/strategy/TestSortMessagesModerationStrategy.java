...
/**
 *  Test message list manipulations with Moderation Strategy.
 */
public class TestSortMessagesModerationStrategy {
        @Test
        void test() {
                // Given
                ...
                add(msgs, m1);
                Message m2 = new Message("spam, you!", temp);
                add(msgs, m2);
                ...
                // Then
                assertThat(msgs.get(m1).getScore(), is(-100));
                assertThat(msgs.get(m2).getScore(), is(-50));
                ...
                //assertThat(sortedMessageList, contains());
        }
